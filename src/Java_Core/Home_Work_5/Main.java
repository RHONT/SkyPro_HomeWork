...
//        task9();
//        task10();
        Integer[][] arr = new Integer[][]{{1, 4}, {5, 2}, {1, 7}};
        Stream<Integer> numbers = Stream.of(arr).flatMap(Stream::of);

//        Integer[] res = numbers.toArray(Integer[]::new);//[1, 4, 5, 2, 1, 7]
        Integer[] re2 = Stream.of(arr).map(a -> a[1]).toArray(Integer[]::new);//[4, 2, 7]
